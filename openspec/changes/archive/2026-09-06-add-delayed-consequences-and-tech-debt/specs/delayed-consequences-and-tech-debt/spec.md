...
The game SHALL execute supported resource, Focus, delayed, and probabilistic effects through a validated domain contract without requiring a Phaser scene, and SHALL preserve their declared order.

#### Scenario: A mixed effect list is executed
- **WHEN** a valid ordered list contains immediate resource, Focus, and consequence effects
