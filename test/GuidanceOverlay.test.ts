...
describe('guidance presentation',()=>{
 it('names every required concept concisely',()=>{const copy=Object.values(GUIDANCE_COPY).join(' ');for(const term of ['17:00','Hold to Code','Urgent alerts','Resources','START WORKING'])assert.match(copy,new RegExp(term,'i'));});
