...
export const PR_REVIEW_STICKIES:readonly InterruptionDefinition[]=Object.freeze([
 {id:'ambient-review',category:'teammate',severity:'medium',title:'REVIEW REQUEST · #1842',copy:'Nina requested your review on “Guard duplicate payment retries”.',baseWeight:1,deduplicationKey:'ambient-review-payments',cooldownGameMs:m(30),choices:[choice('review-now','REVIEW NOW','Spend 12 minutes; protect stability.',12,[{type:'resource',resource:'systemStability',amount:5}],{resultKarma:'constructive',followUps:[{eventId:'ambient-review',delayGameMs:m(30)}]}),choice('wave-through','WAVE THROUGH','Save time; accept debt.',2,[{type:'resource',resource:'technicalDebt',amount:7}],{resultKarma:'self-serving',followUps:[{eventId:'ambient-review',delayGameMs:m(30)}]})]},
 {id:'ambient-review-migration',category:'teammate',severity:'high',title:'CHANGES REQUESTED · #1917',copy:'Omar requested your review on “Remove the legacy session migration”. 23 files changed.',baseWeight:1,deduplicationKey:'ambient-review-migration',cooldownGameMs:m(40),choices:[choice('review-migration','TRACE THE MIGRATION','Spend 18 minutes; reduce debt and catch risky assumptions.',18,[{type:'resource',resource:'technicalDebt',amount:-5},{type:'resource',resource:'systemStability',amount:4}],{resultKarma:'constructive',followUps:[{eventId:'ambient-review-migration',delayGameMs:m(40)}]}),choice('rubber-stamp-migration','APPROVE ANYWAY','Clear the notification fast; gamble with stability.',2,[{type:'resource',resource:'technicalDebt',amount:8},{type:'resource',resource:'systemStability',amount:-6}],{resultKarma:'self-serving',followUps:[{eventId:'ambient-review-migration',delayGameMs:m(40)}]})]},
 {id:'ambient-review-tests',category:'teammate',severity:'low',title:'RE-REVIEW REQUEST · #1931',copy:'Priya pushed fixes to “Stabilize the flaky checkout tests” and requested another look.',baseWeight:1,deduplicationKey:'ambient-review-tests',cooldownGameMs:m(35),choices:[choice('review-tests','CHECK THE DIFF','Spend 9 minutes; help finish the fix cleanly.',9,[{type:'resource',resource:'systemStability',amount:3},{type:'resource',resource:'poHappiness',amount:2}],{resultKarma:'constructive',followUps:[{eventId:'ambient-review-tests',delayGameMs:m(35)}]}),choice('ask-again','ASK FOR MORE TESTS','Spend 3 minutes and send it back; preserve your time, not theirs.',3,[{type:'resource',resource:'poHappiness',amount:-2}],{resultKarma:'self-serving',followUps:[{eventId:'ambient-review-tests',delayGameMs:m(35)}]})]},
 {id:'ambient-review-hotfix',category:'teammate',severity:'critical',title:'URGENT REVIEW · #1944',copy:'Luis needs one approval on “Hotfix: stop duplicate invoice emails” before deploy.',baseWeight:0.75,deduplicationKey:'ambient-review-hotfix',cooldownGameMs:m(45),choices:[choice('review-hotfix','REVIEW THE HOTFIX','Spend 14 minutes; protect customers and production.',14,[{type:'resource',resource:'systemStability',amount:7},{type:'resource',resource:'poHappiness',amount:4}],{resultKarma:'constructive',followUps:[{eventId:'ambient-review-hotfix',delayGameMs:m(45)}]}),choice('approve-hotfix-blind','APPROVE BLIND','Unblock deploy now; leave risk and debt behind.',1,[{type:'resource',resource:'technicalDebt',amount:6},{type:'resource',resource:'systemStability',amount:-9}],{resultKarma:'self-serving',followUps:[{eventId:'ambient-review-hotfix',delayGameMs:m(45)}]})]}
]);
