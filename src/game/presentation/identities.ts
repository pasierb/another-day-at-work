...
export function notificationIdentity(id:string,category:string):NotificationIdentity{
 ...
 if(category==='teammate')return{sender:'Engineering Team',channel:'Slack',texture:'presentation.service.slack',fallback:'TM'};
 ...
 if(id==='tooling-github')return{sender:'GitHub',channel:'Status update',fallback:'GH'};
